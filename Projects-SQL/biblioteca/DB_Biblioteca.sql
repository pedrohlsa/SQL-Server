USE [Biblioteca]
GO
/****** Objeto:  Table [dbo].[alugar_livro]    Data do Script: 17/05/2026 17:51:57 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Objeto:  Table [dbo].[assunto]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[autor]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[cliente]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[compra]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[departamento]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[editora]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[endereco_cliente]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[endereco_fornecedor]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[endereco_fornecedor](
...
GO
/****** Objeto:  Table [dbo].[forma_pgto]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[forn_livro]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[fornecedor]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[funcionario]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[info_func]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[info_func](
...
GO
/****** Objeto:  Table [dbo].[item_venda]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[livro]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[livro_autor]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[logs]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[manutencao_chamado]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[manutencao_gastos]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[movimentacao_estoque]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[pagamento_func]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[pagamento_parcelas]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[parcelas_compra]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[preco_historico]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Objeto:  Table [dbo].[venda]    Data do Script: 17/05/2026 17:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[funcionario] ADD  DEFAULT ('Ativo') FOR [status_funcionario]
GO
...
GO
ALTER TABLE [dbo].[endereco_fornecedor]  WITH CHECK ADD  CONSTRAINT [fk_info_fornecedor] FOREIGN KEY([id_fornecedor])
REFERENCES [dbo].[fornecedor] ([id_fornecedor])
GO
ALTER TABLE [dbo].[endereco_fornecedor] CHECK CONSTRAINT [fk_info_fornecedor]
GO
...
GO
ALTER TABLE [dbo].[info_func]  WITH CHECK ADD  CONSTRAINT [FK_info_funcionario__funcionario] FOREIGN KEY([id_funcionario])
REFERENCES [dbo].[funcionario] ([id_funcionario])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[info_func] CHECK CONSTRAINT [FK_info_funcionario__funcionario]
GO
...
GO
ALTER TABLE [dbo].[endereco_fornecedor]  WITH CHECK ADD CHECK  (([email] like '_%@_%._%'))
GO
